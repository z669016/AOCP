...
is_deeply (AOC::Input::load("./t/t.2.txt", {"sort"=> 1}), [qw/a d j k l p q t z/], "sorted text file");
sub sort_reverse {
    my ($first ,$second) = @_;
    $second cmp $first;
};
is_deeply (AOC::Input::load("./t/t.2.txt", {"sort" => \&sort_reverse}), [reverse qw/a d j k l p q t z/], "sorted text file");
